...
#[derive(Deserialize)]
struct ReadBody { path: String, fs_type: String }
...
#[derive(Deserialize)]
struct WriteBody { path: String, content: String, fs_type: String }
...
#[derive(Deserialize)]
struct ListBody { path: String, fs_type: String }
...
#[derive(Deserialize)]
struct DeleteBody { path: String, fs_type: String }
...
#[derive(Deserialize)]
struct ExistsBody { path: String, fs_type: String }
...
#[derive(Deserialize)]
struct MkdirBody { path: String, fs_type: String }
