...
pub fn routes() -> Router {
    Router::new()
        .route("/scenario", get(get_scenario).post(save_scenario))
}

#[derive(Deserialize)]
struct ScenarioQuery { project_path: String }
...
#[derive(Deserialize)]
struct SaveScenarioBody { project_path: String, scenario: crate::scenario::ProjectScenario }
