...
) -> Json<super::ApiResponse<Vec<crate::digital_employee::DigitalEmployee>>> {
...
) -> Json<super::ApiResponse<Option<crate::digital_employee::DigitalEmployee>>> {
    api_ok!(crate::digital_employee::de_get(q.code, q.db_type))
}

#[derive(Deserialize)]
struct SaveBody {
    employee: crate::digital_employee::DigitalEmployee,
    db_type: String,
}
