  ...
  businessFlow: {
    ...
    editor: {
      ...
      actions: {
        ...
        deleteBuiltin: '内置流程不可删除',
        unsavedChanges: '未保存的更改将丢失，是否继续？',
        copySuccess: '流程已复制',
        publishConfirm: '发布此流程？发布后将变为只读。',
    ...
    errors: {
      notFound: '流程未找到',
      lockConflict: '该流程已被其他地方修改，请重新加载。',
      publishedLocked: '已发布的流程不可修改，请先复制。',
      cycleDetected: '流程存在循环',
      noStart: '流程缺少开始节点',
      noEnd: '流程缺少结束节点',
    },
  },
