  ...
  businessFlow: {
    ...
    editor: {
      ...
      actions: {
        ...
        deleteBuiltin: 'Built-in flows cannot be deleted',
        unsavedChanges: 'Unsaved changes will be lost. Continue?',
        copySuccess: 'Flow copied',
        publishConfirm: 'Publish this flow? It will become read-only.',
        publishSuccess: 'Flow published',
      },
    },
    run: {
      title: 'Run Flow',
    ...
    errors: {
      ...
      lockConflict: 'This flow was modified elsewhere. Please reload.',
      publishedLocked: 'Cannot modify a published flow. Copy it first.',
      cycleDetected: 'Flow contains a cycle',
      noStart: 'Flow must have a Start node',
      noEnd: 'Flow must have an End node',
    },
  },
}
